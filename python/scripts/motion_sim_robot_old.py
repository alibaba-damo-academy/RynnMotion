...
class MotionSimRobot:
    ...
    def init_fsm(self):
        ...
        self.fsm_type = self.fsm_config.get("fsm_type", "basic_fsm")
        ...
        self.logger.info(f"✓ FSM build seccessfully!\n")
    ...
    def run(self):
        ...
        try:
            while True:
                ...
                # fsm update and task is managed in fsm
                self.fsm.update()
                """
                robot_state = self.robot_interface.get_robot_state_feedbacks()
                ...
                """
                # robot state publish
                robot_state = self.robot_interface.get_robot_state_without_update()
