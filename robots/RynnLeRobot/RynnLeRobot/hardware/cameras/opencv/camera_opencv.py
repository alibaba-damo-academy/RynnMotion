...
from RynnLeRobot.hardware.cameras.camera import Camera
from RynnLeRobot.hardware.cameras.utils import get_cv2_backend, get_cv2_rotation
...
class OpenCVCamera(Camera):
    ...
    Example:
        ```python
        from hardware.cameras.opencv import OpenCVCamera
        from hardware.cameras.opencv.configuration_opencv import OpenCVCameraConfig, ColorMode, Cv2Rotation
