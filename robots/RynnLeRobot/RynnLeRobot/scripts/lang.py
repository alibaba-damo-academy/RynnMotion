"""Language support for setup scripts (English/Chinese)."""

import os

# Global language setting - read from env var or default to English
_current_lang = os.environ.get("RYNNMOTION_LANG", "en")
...
MESSAGES = {
    "en": {
        ...
        "updated_second_leader_port": "✓ Updated {config_path} with second leader port: {port}",
        ...
        "second_leader_port": "  Second leader port: {port}",
        "dev_type_follower": "follower",
        "dev_type_leader": "leader",
        "dev_type_second_leader": "second leader",
        ...
        "calib_header_second_leader": "CALIBRATING SECOND LEADER",
        ...
        "calib_use_existing": "Type 'c' and press ENTER to run calibration again, or Press ENTER to use provided calibration file for {id} : ",
        ...
        "calib_second_leader_status": "  Second Leader: {status}",
        ...
        "show_angles_select_device": "Select device to monitor (1/2/3, default=1): ",
        "show_angles_option_follower": "  1. Follower (SO101)",
        "show_angles_option_leader": "  2. Leader (SO101)",
        "show_angles_option_second_leader": "  3. Second Leader (SO101)",
    ...
    "zh": {
        ...
        "updated_second_leader_port": "✓ 已更新 {config_path} 第二主臂端口：{port}",
        ...
        "second_leader_port": "  第二主臂端口：{port}",
        "dev_type_follower": "从臂",
        "dev_type_leader": "主臂",
        "dev_type_second_leader": "第二主臂",
        ...
        "calib_second_leader_status": "  第二主臂：{status}",
        ...
        "show_angles_select_device": "选择要监控的设备 (1/2/3, 默认=1): ",
        "show_angles_option_follower": "  1. 从臂 (SO101)",
        "show_angles_option_leader": "  2. 主臂 (SO101)",
        "show_angles_option_second_leader": "  3. 第二主臂 (SO101)",
...
def select_language():
    ...
    if os.environ.get("RYNNMOTION_LANG"):
        return
