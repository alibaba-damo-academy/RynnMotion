...
"""Follower arm sine wave motion test.

Usage:
    $ follower-jointsine --joint 1
"""
...
def main():
    ...
    lerobot_yaml_data = load_config("configs/so101.yaml")
    calibration_dir = lerobot_yaml_data.get("robot", {}).get("calibration_dir", None)
    default_flag = False
    try:
